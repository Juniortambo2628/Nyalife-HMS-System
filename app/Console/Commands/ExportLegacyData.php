...
class ExportLegacyData extends Command
{
    ...
    private function exportUsers($legacyDb)
    {
        ...
        if ($users->isEmpty()) return "-- No users to export\n\n";
    ...
    private function exportPatients()
    {
        ...
        if ($patients->isEmpty()) return "-- No patients to export\n\n";
    ...
    private function exportDepartments()
    {
        ...
        if ($departments->isEmpty()) return "-- No departments to export\n\n";
    ...
    private function exportStaff()
    {
        ...
        if ($staff->isEmpty()) return "-- No staff to export\n\n";
    ...
    private function exportAppointments()
    {
        ...
        if ($appts->isEmpty()) return "-- No appointments to export\n\n";
    ...
    private function exportConsultations()
    {
        ...
        if ($consults->isEmpty()) return "-- No consultations to export\n\n";
    ...
    private function exportPrescriptions()
    {
        ...
        if ($rx->isEmpty()) return "-- No prescriptions to export\n\n";
    ...
    private function exportPrescriptionItems()
    {
        ...
        if ($items->isEmpty()) return "-- No prescription items to export\n\n";
    ...
    private function exportInvoices()
    {
        ...
        if ($invoices->isEmpty()) return "-- No invoices to export\n\n";
    ...
    private function exportInvoiceItems()
    {
        ...
        if ($items->isEmpty()) return "-- No invoice items to export\n\n";
    ...
    private function exportPayments()
    {
        ...
        if ($payments->isEmpty()) return "-- No payments to export\n\n";
    ...
    private function exportLabTestTypes()
    {
        ...
        if ($types->isEmpty()) return "-- No lab test types to export\n\n";
    ...
    private function exportLabRequests()
    {
        ...
        if ($requests->isEmpty()) return "-- No lab requests to export\n\n";
    ...
    private function exportLabSamples()
    {
        ...
        if ($samples->isEmpty()) return "-- No lab samples to export\n\n";
    ...
    private function exportVitals()
    {
        ...
        if ($vitals->isEmpty()) return "-- No vitals to export\n\n";
    ...
    private function exportFollowUps()
    {
        ...
        if ($followUps->isEmpty()) return "-- No follow-ups to export\n\n";
    ...
    private function exportRadiology()
    {
        ...
        if ($radio->isEmpty()) return "-- No radiology requests to export\n\n";
    ...
    private function exportTelehealth()
    {
        ...
        if ($tele->isEmpty()) return "-- No telehealth consents to export\n\n";
    ...
    private function exportPharmacy()
    {
        ...
        if ($orders->isEmpty()) return "-- No pharmacy orders to export\n\n";
    ...
    private function exportMedicalProcedures()
    {
        ...
        if ($procedures->isEmpty()) return "-- No medical procedures to export\n\n";
    ...
    private function exportInsurance()
    {
        ...
        if ($insurance->isEmpty()) return "-- No insurance to export\n\n";
