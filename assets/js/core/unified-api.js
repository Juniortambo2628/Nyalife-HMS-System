/**
 * Nyalife HMS - Unified API System
 * 
 * This file consolidates all API functionality from:
 * - common/ajax-utils.js
 * - core/api.js
 * 
 * Provides a single, consistent API interface across the application.
 */
