/**
 * Nyalife HMS - Unified Forms System
 * 
 * This file consolidates all form functionality from:
 * - form-validation.js
 * - core/forms.js
 * - common/form-utils.js
 * 
 * Provides a single, consistent forms interface across the application.
 */
    ...
    return {
        ...
        submitFormAjax: function(form, options = {}) {
            ...
            return new Promise((resolve, reject) => {
                // Show loader if available and not on dashboard page
