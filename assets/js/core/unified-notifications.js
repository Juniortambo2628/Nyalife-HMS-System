/**
 * Nyalife HMS - Unified Notifications System
 * 
 * This file consolidates all notification functionality from:
 * - alerts.js
 * - core/notifications.js
 * 
 * Provides a single, consistent notification interface across the application.
 */
    ...
    return {
        ...
        showNotification: function(type, message, options = {}) {
            ...
            if (type === 'error' || type === 'warning') {
                return this.showAlert(type, message, options);
            } else {
                // For success and info, use toasts (less intrusive)
                return this.showToast(options.title || '', message, type, options);
            }
        },
