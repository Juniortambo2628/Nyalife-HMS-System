...
class LabAndMedicationSeeder extends Seeder
{
    ...
    private function seedLabTemplates(): void
    {
        $templates = [
            ...
            'Pap Smear' => [
                ['label' => 'Specimen Adequacy', 'normalRange' => 'Satisfactory for evaluation', 'unit' => ''],
                ['label' => 'Transformation Zone Component', 'normalRange' => 'Present (Endocervical/squamous metaplastic cells present)', 'unit' => ''],
                ['label' => 'General Categorization', 'normalRange' => 'Negative for intraepithelial lesion or malignancy', 'unit' => ''],
                ['label' => 'Epithelial Cell Classification', 'normalRange' => 'Normal squamous and endocervical cells', 'unit' => ''],
                ['label' => 'Pathogenic Organisms', 'normalRange' => 'None identified', 'unit' => ''],
                ['label' => 'Recommendation', 'normalRange' => 'Routine screening in 3 years', 'unit' => ''],
            ],
            'Pap Smear Cytology' => [
                ['label' => 'Specimen Adequacy', 'normalRange' => 'Satisfactory for evaluation', 'unit' => ''],
                ['label' => 'Transformation Zone Component', 'normalRange' => 'Present (Endocervical/squamous metaplastic cells present)', 'unit' => ''],
            ...
            'Laboratory-Pathology - Pap smear procedure and reporting' => [
                ['label' => 'Specimen Adequacy', 'normalRange' => 'Satisfactory for evaluation', 'unit' => ''],
                ['label' => 'Transformation Zone Component', 'normalRange' => 'Present (Endocervical/squamous metaplastic cells present)', 'unit' => ''],
                ['label' => 'General Categorization', 'normalRange' => 'Negative for intraepithelial lesion or malignancy', 'unit' => ''],
                ['label' => 'Epithelial Cell Classification', 'normalRange' => 'Normal squamous and endocervical cells', 'unit' => ''],
