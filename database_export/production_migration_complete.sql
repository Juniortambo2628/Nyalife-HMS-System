-- =====================================================
-- NYALIFE HMS PRODUCTION DATABASE MIGRATION SCRIPT
-- =====================================================
...
-- IMPORTANT PRODUCTION MIGRATION INSTRUCTIONS:
-- =====================================================
-- 1. BACKUP YOUR EXISTING DATABASE FIRST
-- 2. Run this script on your production server
-- 3. Ensure MySQL/MariaDB version 10.4+ is installed
-- 4. Run as a user with CREATE, ALTER, INSERT privileges
-- 5. This script will create all tables, constraints, and sample data
-- =====================================================

-- 1. CREATE DATABASE AND SET CHARACTER SET
-- =====================================================
CREATE DATABASE IF NOT EXISTS `nyalifew_hms_prod` 
CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

USE `nyalifew_hms_prod`;

-- 2. DISABLE FOREIGN KEY CHECKS (will be re-enabled later)
-- =====================================================
...
-- =====================================================
-- All tables will be created in proper dependency order
-- Foreign key constraints will be established after all tables exist
...
-- =====================================================
-- 4. RE-ENABLE FOREIGN KEY CHECKS AND COMMIT
-- =====================================================
SET FOREIGN_KEY_CHECKS = 1;
COMMIT;

-- =====================================================
-- 5. VERIFICATION AND POST-MIGRATION CHECKS
-- =====================================================
...
SELECT COUNT(*) as total_foreign_keys FROM information_schema.KEY_COLUMN_USAGE 
WHERE REFERENCED_TABLE_SCHEMA = 'nyalifew_hms_prod' 
AND REFERENCED_TABLE_NAME IS NOT NULL;

-- Check table engines and character sets
...
-- =====================================================
-- 6. PRODUCTION SETUP COMPLETE
-- =====================================================
-- Your Nyalife HMS database has been successfully migrated!
-- 
-- Next steps:
-- 1. Update your application configuration files
-- 2. Test the system functionality
-- 3. Set up proper user accounts and passwords
