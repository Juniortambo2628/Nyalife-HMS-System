...
class InsuranceController extends ApiController {
    ...
    public function getPolicy() {
        ...
        try {
            ...
            $policy = $this->fetchOne($query, [$policyId]);
        ...
        try {
            ...
            if ($patientUserId) {
                ...
                $notificationMessage = "Your insurance policy with " . $companyName['company_name'] . 
                                      " has been " . ($policyId ? 'updated' : 'added') . " to your profile.";
                ...
                $this->execute($notificationSQL, [$patientUserId['user_id'], $notificationMessage, $policyId]);
            }
            ...
            $this->sendResponse([
                'success' => true,
                'policy_id' => $policyId,
                'message' => ($policyId ? 'Insurance policy updated successfully' : 'Insurance policy created successfully')
            ]);
     ...
     * @return void
     */
    public function getPatientPolicies() {
        // Get patient ID
