...
class Router {
     ...
     */
    public function register($method, $path, $controller, $action, $name = null) {
        $route = [
            'method' => $method,
            'path' => $path,
     ...
     */
    public static function handleException($e, $showDetails = false) {
        // Log the exception
