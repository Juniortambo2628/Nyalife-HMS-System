                ...
                <div className="row align-items-center">
                    <div className="col-lg-7 mb-3 mb-lg-0 text-start">
                        <div className="d-flex align-items-center">
                            <div
                                className="bg-primary-dark text-white p-3 rounded-circle me-4 shadow-sm d-none d-md-flex align-items-center justify-content-center"
                            ...
                            <div>
                                ...
                                <p className="mb-0 text-muted small">
                                    ...
                                    clicking "Accept All", you consent to our use of cookies. Review our{' '}
                                    <Link
                                        href={route('cookie-policy')}
                                        className="text-decoration-none fw-bold text-primary hover-underline"
                                    >
                                        Cookie Policy
                                    </Link>{' '}
                                    for details.
