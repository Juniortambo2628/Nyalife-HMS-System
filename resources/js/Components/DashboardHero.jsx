...
export default function DashboardHero({
    ...
    return (
        <div
            className={`card shadow-2xl border-0 ${className} text-white overflow-hidden mb-5 position-relative nyl-hero`}
        >
            ...
            <div className="card-body p-5 d-flex align-items-center position-relative h-100 nyl-hero-body">
                <div className="w-100">
                    <h1 className="display-5 fw-extrabold text-white mb-3 tracking-tighter">{title}</h1>
                    {subtitle && <p className="lead mb-0 opacity-90 fw-medium max-w-2xl">{subtitle}</p>}
