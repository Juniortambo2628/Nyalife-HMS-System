        ...
        try {
            ...
            if (response.data.success) {
                onSuccess({
                    ...
                    label:
                        response.data.select_label ||
                        formatPatientSelectLabel(response.data.full_name, response.data.patient_id),
        ...
        <Modal show={show} onClose={onClose} maxWidth="2xl">
            ...
            <div className="bg-gradient-to-br from-pink-500 via-pink-600 to-pink-700 p-8 flex justify-between items-center text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-pink-100 text-xs mt-1 ml-14 opacity-80 uppercase tracking-widest font-semibold">
                        Immediate Walk-in Registration
                    </p>
                </div>
                <button
                    onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="p-8 bg-white">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    {/* First Name */}
                    <div className="group">
                        <label className="block text-[0.7rem] font-bold text-gray-500 uppercase tracking-[0.1em] mb-2 px-1 transition-colors group-focus-within:text-pink-600">
                            First Name
                        </label>
                        <input
                            type="text"
                        ...
                        />
                        {errors.first_name && (
                            <p className="text-red-500 text-[0.65rem] font-bold mt-1.5 px-1 uppercase tracking-wider">
                                {errors.first_name[0]}
                            </p>
                        )}
                    </div>
