...
export default function Index({ procedures, auth }) {
    ...
    const toggleStatus = useCallback((id) => {
        router.post(
            route('medical-procedures.toggle', id),
            {},
            {
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => <TableCellPrimary>{formatCurrency(row.original.standard_fee)}</TableCellPrimary>,
            },
            {
                header: 'Status',
                                ...
                                <div className="modal-body p-4 space-y-4">
                                    ...
                                    <div className="row g-3">
                                        ...
                                        <div className="col-md-6 space-y-1">
                                            ...
                                            />
                                            {errors.standard_fee && (
                                                <div className="text-danger small mt-1">{errors.standard_fee}</div>
                                            )}
                                        </div>
                                    </div>
                                </div>
