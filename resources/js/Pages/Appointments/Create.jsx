                                ...
                                <form onSubmit={submit}>
                                    <div className="row g-3">
                                        <div className="col-md-6">
                                            ...
                                            <DashboardSelect
                                                ...
                                                onChange={(val, opt) => {
                                                    ...
                                                    setQuickPatientLabel(
                                                        opt?.label || formatPatientSelectLabel('', val),
                                                    );
                                                }}
                                                initialLabel={
                                                    quickPatientLabel ||
                                                    formatPatientSelectLabel(preselected_patient_label, data.patient_id)
                                                }
                                                placeholder="Search Patients..."
                                                className={errors.patient_id ? 'is-invalid' : ''}
                                            />
                                            {errors.patient_id && (
                                                <div className="text-danger small mt-1">{errors.patient_id}</div>
                                            )}
                                        </div>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            />
                                            {errors.doctor_id && (
                                                <div className="text-danger small mt-1">{errors.doctor_id}</div>
                                            )}
                                        </div>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            {errors.appointment_date && (
                                                <div className="invalid-feedback">{errors.appointment_date}</div>
                                            )}
                                        </div>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            {errors.appointment_type && (
                                                <div className="invalid-feedback">{errors.appointment_type}</div>
                                            )}
                                        </div>
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="mb-0 small">
                                                                A secure Jitsi meeting link will be generated upon
                                                                confirmation. The patient will receive the link via
