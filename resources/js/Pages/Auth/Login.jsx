...
export default function Login({ status, canResetPassword, authType = 'patient', cms }) {
    ...
    return (
        <AuthLayout image={config.image} title={config.title} subtitle={config.subtitle}>
            ...
            <div className="login-form-container">
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="mb-3">
                        ...
                        />
                        {errors.password && (
                            <div className="invalid-feedback extra-small fw-bold">{errors.password}</div>
                        )}
                    </div>
                    ...
                    <div className="mb-4 form-check d-flex align-items-center gap-2">
                        ...
                        />
                        <label className="form-check-label small text-muted fw-medium mb-0" htmlFor="remember">
                            Remember me
                        </label>
                    </div>
                    ...
                    <div className="d-grid gap-3">
                        <button
                            type="submit"
                            className="btn btn-primary btn-premium-lg fw-medium shadow-sm hover-lift"
                            disabled={processing}
                        >
                ...
                <div className="mt-5 text-center">
                    {isStaff ? (
                        <p className="text-muted small fw-medium mb-0">
                            ...
                            <a
                                href={`mailto:${cms?.contact_email || 'admin@nyalife.com'}`}
                        ...
                        <p className="text-muted small fw-medium mb-0">
                            Don't have an account?{' '}
                            <Link href={route('register')} className="text-primary fw-medium text-decoration-none">
                                Sign up now
                            </Link>
                        </p>
                    )}
