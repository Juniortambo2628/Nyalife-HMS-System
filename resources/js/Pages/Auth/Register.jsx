...
export default function Register() {
    ...
    const checkGuestEmail = useCallback(
        async (email) => {
            ...
            <div className="registration-form-container">
                    ...
                    {step === 1 ? (
                        <div className="step-1 animate-in fade-in slide-in-from-right-4 duration-500">
                            <div className="row g-3 mb-3">
                                <div className="col-md-6">
                                    <label className="form-label extra-small fw-extrabold text-muted text-uppercase tracking-widest mb-1">
                                        First Name
                                    </label>
                                    <input
                                        type="text"
                                        className={`form-control form-control-premium ${errors.first_name ? 'is-invalid' : ''}`}
                                        name="first_name"
                                    ...
                                    />
                                    {errors.first_name && (
                                        <div className="invalid-feedback extra-small fw-bold">{errors.first_name}</div>
                                    )}
                                </div>
                                <div className="col-md-6">
                                    <label className="form-label extra-small fw-extrabold text-muted text-uppercase tracking-widest mb-1">
                                    ...
                                    <input
                                        type="text"
                                        className={`form-control form-control-premium ${errors.last_name ? 'is-invalid' : ''}`}
                                        name="last_name"
                                    ...
                                    />
                                    {errors.last_name && (
                                        <div className="invalid-feedback extra-small fw-bold">{errors.last_name}</div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="mb-3">
                                ...
                                <div className="position-relative">
                                    ...
                                    />
                                    {checkingEmail && (
                                        <div className="position-absolute end-0 top-50 translate-middle-y me-3 spinner-border spinner-border-sm text-primary"></div>
                                    )}
                                </div>
                                {errors.email && (
                                    <div className="invalid-feedback d-block extra-small fw-bold">{errors.email}</div>
                                )}
                            </div>
                            ...
                            <div className="row g-3 mb-3">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <select
                                        className={`form-select form-control-premium ${errors.gender ? 'is-invalid' : ''}`}
                                        name="gender"
                                        value={data.gender}
                                        onChange={onHandleChange}
                                    >
                            ...
                            <div className="d-grid mt-4">
                                <button
                                    type="button"
                                    className="btn btn-primary btn-premium-lg fw-extrabold shadow-sm hover-lift"
                                    onClick={() => setStep(2)}
                                >
                        ...
                        <div className="step-2 animate-in fade-in slide-in-from-right-4 duration-500">
                            <div className="mb-3">
                                ...
                                <input
                                    type="text"
                                    className={`form-control form-control-premium ${errors.username ? 'is-invalid' : ''}`}
                                    name="username"
                                    value={data.username}
                                    onChange={onHandleChange}
                                    required
                                />
                                {errors.username && (
                                    <div className="invalid-feedback d-block extra-small fw-bold">
                                        {errors.username}
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="row g-3 mb-4">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <input
                                        type="password"
                                        className={`form-control form-control-premium ${errors.password_confirmation ? 'is-invalid' : ''}`}
                            ...
                            <div className="mb-4 form-check d-flex align-items-center gap-2">
                                ...
                                <label className="form-check-label extra-small text-muted fw-bold mb-0" htmlFor="terms">
                                    ...
                                    <Link
                                        ...
                                        className="fw-extrabold text-primary text-decoration-none"
                                    >
                                        TERMS
                                    </Link>{' '}
                                    &{' '}
                            ...
                            <div className="d-flex gap-2">
                                <button
                                    type="button"
                                    className="btn btn-outline-light border text-gray-600 btn-premium-lg flex-grow-1 fw-bold"
                                    onClick={() => setStep(1)}
                                >
                                    BACK
                                </button>
                                <button
                                    type="submit"
                                    className="btn btn-primary btn-premium-lg flex-grow-1 fw-extrabold shadow-sm hover-lift"
                                    disabled={processing}
                                >
                ...
                <div className="mt-5 text-center">
                    <p className="text-muted extra-small fw-bold mb-0">
                        ...
                        <Link href={route('login.patient')} className="text-primary fw-extrabold text-decoration-none">
                            SIGN IN HERE
                        </Link>
                    </p>
                </div>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content border-0 rounded-2xl shadow-2xl overflow-hidden">
                            <div className="modal-body p-5 text-center animate-in zoom-in duration-300">
                                <div
                                    className="bg-primary-subtle text-primary rounded-circle d-inline-flex align-items-center justify-content-center mb-4 shadow-inner"
                                ...
                                <p className="text-muted mb-4 fw-medium">
                                    We found an existing record. Auto-fill details for{' '}
                                ...
                                <div className="d-grid gap-2">
                                    <button
                                        type="button"
                                        className="btn btn-primary rounded-pill py-2.5 fw-extrabold shadow-sm hover-lift"
                                    ...
                                    <button
                                        type="button"
                                        className="btn btn-light rounded-pill py-2.5 text-muted fw-bold"
