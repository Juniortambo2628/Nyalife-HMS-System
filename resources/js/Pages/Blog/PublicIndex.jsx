            ...
            <header className="bg-white border-bottom py-10 mb-8">
                <div className="container px-4 mx-auto text-center">
                    ...
                    <p className="lead text-gray-600 max-w-2xl mx-auto">
                        Expert insights, health tips, and clinic updates from the Nyalife team.
                    </p>
                </div>
            </header>
                        ...
                        <div className="sticky-top" style={{ top: '90px', zIndex: 10 }}>
                            ...
                            {(search || tag || sort !== 'latest') && (
                                <button
                                    ...
                                    className="btn btn-light w-100 rounded-pill shadow-sm py-2"
                                >
                                ...
                                blogData.map((blog) => (
                                    <div key={blog.id} className="col-md-6">
                                        <div className="card h-100 shadow-sm border-0 rounded-2xl overflow-hidden bg-white hover-lift transition-all">
                                            <div
                                                className="position-relative overflow-hidden bg-light h-auto"
                                                style={{ height: '240px' }}
                                            >
                                                <img
                                            ...
                                            <div className="card-body p-4 d-flex flex-column">
                                                <div className="d-flex align-items-center text-muted extra-small mb-3">
                                                    <div
                                                        className="avatar-xs bg-pink-100 text-pink-500 rounded-circle d-flex align-items-center justify-content-center me-2"
                                                ...
                                                <h3 className="h4 card-title fw-bold mb-3 text-gray-900 leading-tight">
                                                    {blog.title}
                                                </h3>
                                ...
                                <div className="col-12 py-20 text-center">
                                    <div className="card border-0 shadow-sm rounded-2xl p-5 bg-white max-w-md mx-auto">
                                        ...
                                        <p className="text-gray-600 mb-4">
                                            We couldn't find any articles matching your search criteria. Try different
                                            keywords or filters.
                                        </p>
                                        <button onClick={clearFilters} className="btn btn-primary rounded-pill px-4">
                                            Browse All Articles
                                        </button>
                                    </div>
                                </div>
