...
export default function Edit({
    ...
    const removePrescription = (idx) =>
        setData(
            'requested_prescriptions',
            (data.requested_prescriptions || []).filter((_, i) => i !== idx),
        );
                ...
                content: (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="d-flex align-items-center gap-3 mb-4">
                            <div
                                className="bg-success-subtle text-success p-2 rounded-circle d-flex align-items-center justify-content-center"
                            ...
                            <div>
                                ...
                                <span className="text-muted small">
                                    {lab.test_type?.category || 'Clinical Laboratory'}
                                </span>
                            </div>
                        ...
                        {hasTemplate ? (
                                ...
                                <table className="table table-hover align-middle mb-0">
                                    <thead className="bg-light">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3 small fw-bold text-muted border-0 text-center">
                                                REF. RANGE
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {lab.test_type.template.map((item, idx) => (
                                            <tr key={idx} className="border-bottom border-light">
                                                ...
                                                <td className="px-4 py-3 fw-bold" style={{ color: '#e91e63' }}>
                                                    {results.lab_results?.[item.label] || '\u2014'}
                                                </td>
                                                <td className="px-4 py-3 text-muted small">{item.unit || '\u2014'}</td>
                                                <td className="px-4 py-3 text-center small text-muted">
                                                    {item.normalRange || '\u2014'}
                                                </td>
                                            </tr>
                                        ))}
                            ...
                            <div className="p-4 border rounded-3" style={{ backgroundColor: '#f0f7ff' }}>
                                <h6 className="fw-bold text-muted text-uppercase mb-2" style={{ fontSize: '0.7rem' }}>
                                    Findings Narrative
                                </h6>
                ...
                content: (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div
                            ...
                            style={{ backgroundColor: '#f9fafb', fontStyle: 'italic', lineHeight: 1.7 }}
                        >
                            {results.observations || 'No specific clinical observations recorded.'}
                        </div>
                        <h4 className="text-gray-400 text-xs font-bold uppercase tracking-widest mt-4">
                            Professional Conclusion
                        </h4>
                        <div
                            className="p-4 rounded-3 border fw-bold"
                            style={{
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        {results.attachments?.length > 0 ? (
                                        ...
                                        >
                                            <div style={{ height: '160px' }} className="position-relative">
                                                {file.type?.startsWith('image/') ? (
                                                    ...
                                                    >
                                                        <i
                                                            className={`fas ${file.type?.includes('pdf') ? 'fa-file-pdf text-danger' : 'fa-file-medical text-primary'} fa-3x`}
                                                            style={{ opacity: 0.5 }}
                                                        ></i>
                                                    </div>
                                                )}
                            ...
                            <div
                                ...
                                style={{ backgroundColor: '#f9fafb', borderRadius: '1.5rem' }}
                            >
                                <i className="fas fa-folder-open text-gray-300 fa-3x mb-3 d-block"></i>
                                <p className="text-muted">
                                    No attachments or images were uploaded for this investigation.
                                </p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="row g-3">
                                ...
                                <div className="col-md-6">
                                    ...
                                    <div className="fw-bold">
                                        {lab.test_type?.turnaround_time || 'Standard Processing'}
                                    </div>
                                </div>
                            </div>
                            {lab.test_type?.template &&
                                Array.isArray(lab.test_type.template) &&
                                lab.test_type.template.length > 0 && (
                                    <div className="mt-3 pt-3 border-top">
                                        ...
                                        <div className="table-responsive">
                                            <table className="table table-sm mb-0 extra-small">
                                                <thead>
                                                    <tr>
                                                        <th className="border-0 text-muted">Parameter</th>
                                                        <th className="border-0 text-muted">Unit</th>
                                                        <th className="border-0 text-muted">Normal Range</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <span className={`fw-bold ${lab.priority === 'urgent' ? 'text-danger' : ''}`}>
                                    {(lab.priority || 'normal').toUpperCase()}
                                </span>
                            </div>
                            <div
                                className="d-flex justify-content-between border-bottom pb-2"
                            ...
                            >
                                ...
                                <span className="fw-bold">
                                    {lab.created_at ? formatDateTime(lab.created_at) : 'N/A'}
                                </span>
                            </div>
                            <div
                                className="d-flex justify-content-between border-bottom pb-2"
                                ...
                                <span className="fw-bold">
                                    {lab.assignedToUser ? (
                                        <span className="d-inline-flex align-items-center gap-2">
                                            <span
                                                className="bg-primary-subtle text-primary rounded-circle d-inline-flex align-items-center justify-content-center"
                                                style={{
                                                    width: '28px',
                                                    height: '28px',
                                                    fontSize: '0.7rem',
                                            ...
                                            >
                                                {lab.assignedToUser.first_name?.charAt(0)}
                                                {lab.assignedToUser.last_name?.charAt(0)}
                                            </span>
                            ...
                            {lab.notes && (
                                <div className="mt-3 pt-3 border-top">
                                    ...
                                    <div className="p-3 rounded-2 bg-light" style={{ whiteSpace: 'pre-wrap' }}>
                                        {lab.notes}
                                    </div>
                                </div>
                            )}
    ...
    return (
        ...
        >
            ...
            <form onSubmit={(e) => submit(e, 'completed')} className="row g-4 pb-5">
                    ...
                    <div className="row g-3 mb-4">
                        <FormField label="Priority Level" className="col-md-4">
                            <div className="d-flex gap-2">
                                <button
                                    type="button"
                                    className={`btn rounded-pill px-4 flex-fill fw-bold ${data.priority === 'normal' ? 'btn-primary' : 'btn-light'}`}
                                ...
                                <button
                                    type="button"
                                    className={`btn rounded-pill px-4 flex-fill fw-bold ${data.priority === 'emergency' ? 'btn-danger' : 'btn-light'}`}
                        ...
                        <div className="col-12">
                            ...
                            >
                                <div className="row g-4">
                                        ...
                                        <div className="row g-3">
                                            ...
                                            <FormField label="Regularity" className="col-md-6">
                                                <FormSelect
                                                    ...
                                                    onChange={(e) =>
                                                        setNestedData('menstrual_history', 'regularity', e.target.value)
                                                    }
                                                    options={[
                                    ...
                                    <div className="col-lg-6">
                                        <FormField label="Cervical Screening">
                                            <textarea
                                                className="form-control"
                                                rows="2"
                                        ...
                                        <div className="row g-2">
                                            <div className="col-md-2">
                                                <input
                                                    ...
                                                    placeholder="Year"
                                                    value={rec.year}
                                                    onChange={(e) => updateObstetricRecord(idx, 'year', e.target.value)}
                                                />
                                            </div>
                                            ...
                                            <div className="col-md-3">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        updateObstetricRecord(idx, 'mode_of_delivery', e.target.value)
                                                    }
                                                />
                                            </div>
                                            <div className="col-md-2">
                                            ...
                                            <div className="col-md-2">
                                                <input
                                                    ...
                                                    placeholder="Sex"
                                                    value={rec.sex}
                                                    onChange={(e) => updateObstetricRecord(idx, 'sex', e.target.value)}
                                                />
                                            </div>
                                            <div className="col-md-2">
                                                <input
                ...
                <div className="col-12">
                    <FormSection
                        ...
                        bodyClassName="p-4 overflow-visible"
                    >
                        <div className="row g-4 overflow-visible">
                            <div className="col-lg-4 border-end overflow-visible">
                                ...
                                {existingLabs.length > 0 && (
                                    <div className="mb-4">
                                        <h6 className="text-xs fw-bold text-primary text-uppercase mb-2">
                                            Already Requested
                                        </h6>
                                        <div className="d-flex flex-wrap gap-2 mb-3">
                                            {existingLabs.map((lab) => (
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <i
                                                            className={`fas ${lab.status === 'completed' ? 'fa-check-double' : 'fa-clock'} me-1`}
                                                        ></i>
                                                    ...
                                                    {lab.status === 'pending' && (
                                                        <button
                                                            ...
                                                            onClick={(e) => {
                                                                ...
                                                                if (
                                                                    confirm(
                                                                        'Are you sure you want to remove this pending lab request?',
                                                                    )
                                                                ) {
                                                                    router.delete(
                                                                        route('lab.requests.destroy', lab.request_id),
                                                                        {
                                                                            preserveScroll: true,
                                                                            onSuccess: () => {
                                ...
                                {data.requested_labs.map((l) => (
                                    <div
                                        key={l.test_type_id}
                                        className="d-flex justify-content-between p-2 bg-light mb-1 rounded small"
                                    >
                                        {l.test_name}
                                        <button
                                            type="button"
                                            aria-label={`Remove lab ${l.test_name}`}
                                ...
                                <ul className="list-group list-group-flush mb-0">
                                    {data.requested_service_items.map((s) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                type="button"
                                                aria-label={`Remove service ${s.test_name}`}
                                    ...
                                    {data.requested_service_items.length === 0 && (
                                        <li className="list-group-item border-0 bg-transparent text-muted small px-0">
                                            <em>No services selected.</em>
                                        </li>
                                    )}
                                </ul>

                                <h6 className="fw-bold mb-3 mt-4 text-secondary small text-uppercase border-top pt-3">
                                    Surgeries
                                </h6>
                                <select
                                    className="form-select bg-light border-0 mb-3"
                                ...
                                <ul className="list-group list-group-flush mb-0">
                                    {data.requested_procedures.map((p) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                type="button"
                                                aria-label={`Remove procedure ${p.name}`}
                                            ...
                                            {prescriptions.map((rx) => (
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        <span className="text-secondary extra-small text-capitalize">
                                                            {rx.status || 'pending'}
                                                        </span>
                                                    </div>
                                                    <button
                                                        ...
                                                        onClick={() =>
                                                            router.visit(
                                                                route('prescriptions.show', rx.prescription_id),
                                                            )
                                                        }
                                                    >
                                                        View
                                            ...
                                            <div className="row g-2 mb-2">
                                                <div className="col-6">
                                                    <input
                                                        ...
                                                        value={newRx.dosage}
                                                        onChange={(e) =>
                                                            setNewRx((p) => ({ ...p, dosage: e.target.value }))
                                                        }
                                                    />
                                                </div>
                                                <div className="col-6">
                                            ...
                                            <div className="row g-2 mb-2">
                                                <div className="col-6">
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setNewRx((p) => ({ ...p, duration: e.target.value }))
                                                        }
                                                    />
                                                </div>
                                                <div className="col-6">
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setNewRx((p) => ({ ...p, instructions: e.target.value }))
                                                        }
                                                    />
                                                </div>
                                            </div>
                                ...
                                <ul className="list-group list-group-flush mb-0">
                                    {(data.requested_prescriptions || []).map((rx, idx) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                type="button"
                                                aria-label={`Remove prescription for ${rx.medication_name}`}
                                    ...
                                    {(!data.requested_prescriptions || data.requested_prescriptions.length === 0) && (
                                        <li className="list-group-item border-0 bg-transparent text-muted small px-0">
                                            <em>No prescriptions added.</em>
                                        </li>
                                    )}
                                </ul>
                            </div>
            ...
            {toast && (
                <div
                    className={`position-fixed top-0 end-0 m-4 z-3 alert alert-${toast.type} shadow-lg animate-fade-in`}
                >
                    {toast.message}
                    <button onClick={() => setToast(null)} aria-label="Close" className="btn-close ms-3"></button>
                </div>
            )}
            ...
            <Modal show={showLabConfirmModal} onClose={() => setShowLabConfirmModal(false)}>
                <div className="p-4">
                    <h5 className="fw-bold mb-3">
                        <i className="fas fa-question-circle text-primary me-2"></i>Move Services to Labs?
                    </h5>
                    <p>
                        You have items in your Services list. Should these be officially requested as lab tests and
                        billed to the patient now?
                    </p>
                    <div className="d-flex justify-content-end gap-2">
                        ...
                        <button className="btn btn-primary rounded-pill px-4" onClick={confirmMoveToLabs}>
                            Yes, Move & Save
                        </button>
                    </div>
                </div>
