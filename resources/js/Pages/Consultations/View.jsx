                    ...
                    <div className="table-responsive animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <table className="table table-hover align-middle">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-4 py-3 extra-small fw-extrabold text-muted text-uppercase border-0">
                                        Parameter
                                    </th>
                                    <th className="px-4 py-3 extra-small fw-extrabold text-muted text-uppercase border-0">
                                        Result
                            ...
                            <tbody className="border-0">
                                {results.quantitative.map((r, idx) => (
                                    <tr key={idx} className="border-bottom border-gray-50">
                                        ...
                                        <td className="px-4 py-3 text-muted font-mono extra-small">
                                            {r.normalRange || '-'}
                                        </td>
                                        <td className="px-4 py-3">
                                            {r.isAbnormal ? (
                                                <span className="badge bg-danger-subtle text-danger rounded-pill px-3 py-1.5 fw-bold extra-small text-uppercase">
                                                    <i className="fas fa-exclamation-triangle me-1"></i>Abnormal
                                                </span>
                                            ) : (
                                                <span className="badge bg-success-subtle text-success rounded-pill px-3 py-1.5 fw-bold extra-small text-uppercase">
                                                    <i className="fas fa-check me-1"></i>Normal
                                                </span>
                                            )}
                                        </td>
                                    </tr>
                ...
                content: (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="p-5 bg-gray-50 rounded-3xl border border-gray-100 shadow-inner">
                            <h6 className="extra-small fw-extrabold text-primary text-uppercase tracking-widest mb-4">
                ...
                content: (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="p-5 bg-primary-subtle rounded-3xl border border-primary-subtle shadow-sm">
                            ...
                            <div
                                className="text-primary-emphasis fw-extrabold leading-relaxed"
                                style={{ whiteSpace: 'pre-wrap' }}
                            >
                                {results.conclusion}
                            </div>
                            ...
                            {results.attachments.map((file, idx) => (
                                <div key={idx} className="col-sm-6">
                                    <a
                                        ...
                                        className="card h-100 border-0 shadow-sm rounded-2xl bg-white hover-lift transition-all p-3"
                                    >
                                        <div className="d-flex align-items-center gap-3">
                                            <div className="avatar-md bg-light rounded-xl d-flex align-items-center justify-content-center">
                                                <i
                                                    className={`fas fa-lg ${file.type.startsWith('image') ? 'fa-file-image text-pink-500' : 'fa-file-pdf text-danger'}`}
                                                ></i>
                                            </div>
                                            <div className="overflow-hidden">
                                                <h6
                                                    className="text-truncate mb-0 fw-bold small text-gray-900"
                                                    title={file.name}
                                                >
                                                    {file.name}
                                                </h6>
                                                <div className="extra-small text-muted font-bold opacity-50 text-uppercase">
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="p-4 rounded-2xl bg-blue-50 border border-blue-100 shadow-inner">
                        <div className="row g-4">
                            <div className="col-6">
                                <div className="extra-small text-blue-400 fw-extrabold text-uppercase tracking-widest mb-1">
                                    Investigation
                                </div>
                    ...
                    <div className="space-y-3 px-2">
                        <div className="d-flex justify-content-between border-bottom border-gray-50 pb-2">
                            ...
                            <span className="badge bg-success rounded-pill px-3 py-1 fw-extrabold extra-small">
                                {(lab.status || 'completed').toUpperCase()}
                            </span>
                        </div>
                        <div className="d-flex justify-content-between border-bottom border-gray-50 pb-2">
                            ...
                            <span className="fw-extrabold text-gray-900 small">
                                {lab.completed_at ? formatDateTime(lab.completed_at) : 'N/A'}
                            </span>
                        </div>
                        <div className="d-flex justify-content-between border-bottom border-gray-50 pb-2">
                    ...
                    <div className="col-lg-3">
                        <div className="card border-0 shadow-sm rounded-3xl mb-4 text-center overflow-hidden bg-white shadow-hover">
                            <div className="card-header bg-gradient-primary-to-secondary p-5 border-0">
                                ...
                                <h5 className="mb-1 text-white fw-extrabold tracking-tighter">
                            ...
                            <div className="card-body p-4 text-start">
                                <div className="space-y-4">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                        ...
                                        <span className="fw-extrabold text-gray-900 small">
                                            Dr. {consultation.doctor.user.last_name}
                                        </span>
                                    </div>
                                    <div className="d-flex justify-content-between align-items-center">
                                        <span className="extra-small fw-bold text-muted text-uppercase">Status</span>
                                        <span
                                            className={`badge rounded-pill px-3 py-1 fw-extrabold extra-small text-uppercase ${consultation.consultation_status === 'closed' ? 'bg-success text-white' : 'bg-warning text-dark'}`}
                                        >
                                ...
                                <div className="d-grid mt-5">
                                    <Link
                                        ...
                                        className="btn btn-outline-primary btn-sm rounded-pill fw-bold tracking-widest extra-small py-2.5"
                                    >
                                    ...
                                    <div className="row g-3 text-center">
                                        <div className="col-6">
                                            <div className="p-3 rounded-2xl bg-gray-50 border border-gray-100">
                                                <div className="extra-small text-muted text-uppercase fw-bold opacity-50 mb-1">
                                                    BP
                                                </div>
                                                <div className="fw-extrabold text-gray-900">
                                                    {safeObj(consultation.vital_signs, 'blood_pressure')}
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-6">
                                            <div className="p-3 rounded-2xl bg-gray-50 border border-gray-100">
                                                ...
                                                <div className="fw-extrabold text-gray-900">
                                                    {safeObj(consultation.vital_signs, 'heart_rate')}{' '}
                                                    <span className="extra-small opacity-50">bpm</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-6">
                                            <div className="p-3 rounded-2xl bg-gray-50 border border-gray-100">
                                                ...
                                                <div className="fw-extrabold text-gray-900">
                                                    {safeObj(consultation.vital_signs, 'temperature')}{' '}
                                                    <span className="extra-small opacity-50">°C</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-6">
                                            <div className="p-3 rounded-2xl bg-gray-50 border border-gray-100">
                                                ...
                                                <div className="fw-extrabold text-gray-900">
                                                    {safeObj(consultation.vital_signs, 'oxygen_saturation')}{' '}
                                                    <span className="extra-small opacity-50">%</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {['doctor', 'admin', 'nurse', 'lab_technician', 'receptionist'].includes(auth.user.role) ? (
                            <div className="space-y-6">
                                    ...
                                    <>
                                        ...
                                        <div className="card border-0 shadow-sm rounded-3xl bg-white shadow-hover">
                                            <div className="card-header bg-white py-4 px-5 d-flex justify-content-between align-items-center border-bottom-0">
                                                ...
                                                {auth.user.role === 'doctor' &&
                                                    consultation.consultation_status !== 'cancelled' && (
                                                        <Link
                                                            href={route(
                                                                'consultations.edit',
                                                                consultation.consultation_id,
                                                            )}
                                                            className="btn btn-sm btn-outline-pink rounded-pill px-3 fw-bold extra-small"
                                                        >
                                            ...
                                            <div className="card-body p-5 pt-0">
                                                <div className="p-4 bg-light rounded-2xl border-l-4 border-pink-500 mb-5 shadow-inner">
                                                    <div className="extra-small fw-extrabold text-pink-500 text-uppercase tracking-widest mb-3 opacity-50">
                                                        Chief Complaint
                                                    </div>
                                                    <p className="lead fw-extrabold text-gray-900 mb-0 tracking-tight">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-gray-700 leading-relaxed font-medium">
                                                        {safeText(consultation.history_present_illness)}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-md-6">
                                                <div className="card border-0 shadow-sm rounded-3xl h-100 bg-white shadow-hover">
                                                    <div className="card-body p-5">
                                                        ...
                                                        <div className="mb-4">
                                                            <div className="extra-small text-muted fw-extrabold text-uppercase tracking-widest mb-2 opacity-50">
                                                                Past Medical
                                                            </div>
                                                            <p className="small text-gray-800 fw-bold">
                                                                {safeText(consultation.past_medical_history)}
                                                            </p>
                                                        </div>
                                                        <div>
                                                            <div className="extra-small text-muted fw-extrabold text-uppercase tracking-widest mb-2 opacity-50">
                                                            ...
                                                            <p className="small text-gray-800 fw-bold">
                                                                {safeText(consultation.surgical_history)}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card border-0 shadow-sm rounded-3xl h-100 bg-white shadow-hover">
                                                    <div className="card-body p-5">
                                                        ...
                                                        <div className="mb-4">
                                                            ...
                                                            <p className="small text-gray-800 fw-bold">
                                                                {safeText(consultation.family_history)}
                                                            </p>
                                                        </div>
                                                        <div>
                                                            <div className="extra-small text-muted fw-extrabold text-uppercase tracking-widest mb-2 opacity-50">
                                                            ...
                                                            <p className="small text-gray-800 fw-bold">
                                                                {safeText(consultation.social_history)}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="card border-0 shadow-sm rounded-3xl bg-white shadow-hover overflow-hidden">
                                            <div className="card-header bg-pink-50 text-pink-700 py-4 px-5 border-0 d-flex align-items-center gap-3">
                                                ...
                                                <h6 className="mb-0 fw-extrabold extra-small text-uppercase tracking-widest">
                                                    Reproductive Health Narrative
                                                </h6>
                                            </div>
                                            <div className="card-body p-5">
                                                <div className="row g-5">
                                                    <div className="col-md-6 border-end border-gray-100">
                                                        <h6 className="extra-small fw-extrabold text-pink-400 text-uppercase tracking-widest mb-4">
                                                        ...
                                                        <div className="space-y-3">
                                                            <div className="d-flex justify-content-between">
                                                                ...
                                                                <span className="small fw-extrabold text-gray-900">
                                                                    {safeObj(
                                                                        consultation.menstrual_history,
                                                                        'last_period_date',
                                                                    )}
                                                                </span>
                                                            </div>
                                                            ...
                                                            <div className="d-flex justify-content-between">
                                                                ...
                                                                <span className="small fw-extrabold text-gray-900">
                                                                    {safeText(consultation.cervical_screening)}
                                                                </span>
                                                            </div>
                                                            <div className="d-flex justify-content-between">
                                                                <span className="small text-muted">Contraception:</span>
                                                                <span className="small fw-extrabold text-gray-900">
                                                                    {safeText(consultation.contraceptive_history)}
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6">
                                                        ...
                                                        <div className="row mb-4">
                                                            ...
                                                            <div className="col-6">
                                                                ...
                                                                <div className="fw-extrabold text-gray-900">
                                                                    {safeText(consultation.current_pregnancy)}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        {consultation.obstetric_history && (
                                                            <div className="mb-4">
                                                                ...
                                                                <div className="fw-medium text-gray-900 bg-gray-50 p-3 rounded-2xl">
                                                                    {consultation.obstetric_history}
                                                                </div>
                                                            </div>
                                                        )}
                                                        ...
                                                        {consultation.past_obstetric?.length > 0 ? (
                                                            <div className="table-responsive rounded-2xl border border-gray-100 overflow-hidden shadow-inner">
                                                                <table className="table table-sm table-hover align-middle mb-0 extra-small">
                                                                    <thead className="bg-gray-50">
                                                                        <tr>
                                                                            <th className="px-3 py-2 fw-extrabold border-0">
                                                                                YEAR
                                                                            </th>
                                                                            <th className="px-3 py-2 fw-extrabold border-0">
                                                                                MODE
                                                                    ...
                                                                    <tbody className="border-0">
                                                                        {consultation.past_obstetric.map((rec, i) => (
                                                                            <tr
                                                                                key={i}
                                                                                className="border-bottom border-gray-50"
                                                                            >
                                                                                <td className="px-3 py-2 fw-bold">
                                                                                    {rec.year}
                                                                                </td>
                                                                                <td className="px-3 py-2 text-muted">
                                                                                    {rec.mode_of_delivery}
                                                                                </td>
                                                                                <td className="px-3 py-2 fw-extrabold text-gray-800">
                                                                                    {rec.outcome}
                                                                                </td>
                                                                            </tr>
                                                                        ))}
                                                            ...
                                                            <div className="p-4 bg-gray-50 rounded-2xl text-center">
                                                                <p className="text-muted extra-small fw-bold text-uppercase opacity-50 mb-0">
                                                                    No past pregnancy records found.
                                                                </p>
                                                            </div>
                                                        )}
                                                    </div>
                                        ...
                                        <div className="card border-0 shadow-sm rounded-3xl bg-white shadow-hover mb-4">
                                            ...
                                            <div className="card-body p-5 pt-0">
                                                <p className="small text-gray-800 fw-bold">
                                                    {safeText(consultation.review_of_systems)}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card border-0 shadow-sm rounded-3xl bg-white shadow-hover">
                                            ...
                                            <div className="card-body p-5 pt-0">
                                                <div className="row g-5">
                                                    <div className="col-md-6">
                                                        <div className="extra-small text-muted fw-extrabold text-uppercase tracking-widest mb-3 opacity-50">
                                                            General Systems
                                                        </div>
                                                        <p className="small text-gray-800 fw-bold">
                                                            {safeText(consultation.general_examination)}
                                                        </p>
                                                    </div>
                                                    <div className="col-md-6">
                                                        <div className="extra-small text-muted fw-extrabold text-uppercase tracking-widest mb-3 opacity-50">
                                                        ...
                                                        <p className="small text-gray-800 fw-bold">
                                                            {safeText(consultation.systems_examination)}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="card border-0 shadow-sm rounded-3xl bg-white shadow-hover border-l-4 border-success overflow-hidden">
                                    <div className="card-header bg-success-subtle py-4 px-5 border-0">
                                        <h6 className="mb-0 fw-extrabold text-success-emphasis extra-small text-uppercase tracking-widest">
                                            Diagnosis & Management Protocol
                                        </h6>
                                    </div>
                                    <div className="card-body p-5">
                                        {['doctor', 'admin'].includes(auth.user.role) && (
                                            <div className="mb-5">
                                                <div className="extra-small fw-extrabold text-success text-uppercase tracking-widest mb-3 opacity-50">
                                                    Clinical Impression
                                                </div>
                                                <h4 className="fw-extrabold text-gray-900 tracking-tightest">
                                        ...
                                        <div className="row g-5">
                                            ...
                                            <div className="col-md-6">
                                                ...
                                                <div className="space-y-4 px-2">
                                                    <div>
                                                        <div className="extra-small fw-bold text-success mb-1 uppercase tracking-widest">
                                                            Follow-up
                                                        </div>
                                                        <p className="small fw-extrabold text-gray-900">
                                                            {safeText(consultation.follow_up_instructions)}
                                                        </p>
                                                        {['admin', 'doctor', 'nurse'].includes(auth.user.role) && (
                                                            <Link
                                                                ...
                                                                className="btn btn-sm btn-success rounded-pill mt-2 fw-bold extra-small"
                                                            >
                                                    ...
                                                    {consultation.follow_ups?.length > 0 && (
                                                        <div className="mt-2">
                                                            <div className="extra-small fw-bold text-muted mb-2 uppercase tracking-widest">
                                                                Scheduled
                                                            </div>
                                                            <ul className="list-unstyled mb-0">
                                                                {consultation.follow_ups.map((fu) => (
                                                                    <li
                                                                        key={fu.follow_up_id}
                                                                        className="d-flex justify-content-between align-items-center py-1 border-bottom border-gray-100"
                                                                    >
                                                                        <Link
                                                                            href={route(
                                                                                'follow-ups.show',
                                                    ...
                                                    <div>
                                                        <div className="extra-small fw-bold text-warning mb-1 uppercase tracking-widest">
                                                            Internal Notes
                                                        </div>
                                                        <p className="small text-muted font-medium italic">
                                                            {safeText(consultation.notes)}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="card-body p-5 pt-0">
                                        <div className="row g-5">
                                            ...
                                            <div className="col-lg-4 border-end border-gray-100">
                                                <h6 className="extra-small fw-extrabold text-muted text-uppercase tracking-widest mb-4">
                                                    Laboratory Requests
                                                </h6>
                                                {!consultation.lab_test_requests ||
                                                consultation.lab_test_requests.length === 0 ? (
                                                    <p className="text-muted extra-small italic fw-bold opacity-50">
                                                    ...
                                                    <div className="d-flex flex-wrap gap-2">
                                                        {consultation.lab_test_requests.map((lab) => (
                                                            ...
                                                            >
                                                                <i
                                                                    className={`fas ${lab.status === 'completed' ? 'fa-check-double' : 'fa-clock'} flex-shrink-0`}
                                                                ></i>
                                                                <span className="text-truncate fw-extrabold extra-small">
                                                                    {lab.test_type?.test_name || 'Lab Test'}
                                                                </span>
                                                                {lab.status === 'completed' && (
                                                                    <i className="fas fa-external-link-alt ms-1 flex-shrink-0 extra-small"></i>
                                                                )}
                                                            </button>
                                                        ))}
                                                    </div>
                                            ...
                                            <div className="col-lg-4 border-end border-gray-100">
                                                ...
                                                {!consultation.invoices || consultation.invoices.length === 0 ? (
                                                    <p className="text-muted extra-small italic fw-bold opacity-50">
                                                        No services billed in this visit.
                                                    </p>
                                                ) : (
                                                    <div className="space-y-3">
                                                        {consultation.invoices
                                                            ...
                                                            .filter((item) =>
                                                                ['service', 'procedure'].includes(item.item_type),
                                                            )
                                                            .map((item) => (
                                                                <div
                                                                    key={item.item_id}
                                                                ...
                                                                >
                                                                    <div className="fw-extrabold text-gray-800 small text-truncate">
                                                                        {item.description}
                                                                    </div>
                                                                    <div className="extra-small text-muted font-bold uppercase opacity-50 tracking-widest">
                                                                        {item.item_type}
                                                                    </div>
                                                                </div>
                                                            ))}
                                                    ...
                                                    <div className="space-y-3">
                                                        {consultation.prescriptions
                                                            ...
                                                            .map((item) => (
                                                                <div
                                                                    key={item.item_id}
                                                                    className="p-3 rounded-xl bg-white border border-gray-100 shadow-sm d-flex justify-content-between align-items-center gap-2"
                                                                >
                                                                    <div className="overflow-hidden">
                                                                        <div className="fw-extrabold text-gray-900 small text-truncate">
                                                                            {item.medication?.medication_name || 'MED'}{' '}
                                                                            {item.medication?.strength}
                                                                        </div>
                                                                        <div className="extra-small text-muted font-medium text-truncate">
                                                                            {item.dosage} | {item.frequency} |{' '}
                                                                            {item.duration}
                                                                        </div>
                                                                    </div>
                                                                    <span
                                                                        className={`badge flex-shrink-0 extra-small rounded-pill ${item.rxStatus === 'dispensed' ? 'bg-success text-white' : 'bg-warning text-dark'}`}
                                                                    >
                                                                        {item.rxStatus}
                                                                    </span>
                                                                </div>
                            ...
                            <div className="card border-0 shadow-sm rounded-3xl mb-4 bg-white shadow-hover border-l-4 border-info overflow-hidden">
                                <div className="card-body p-5 text-center py-16">
                                    <div
                                        className="bg-info-subtle text-info p-5 rounded-circle d-inline-flex align-items-center justify-content-center mb-5 shadow-sm border border-info-subtle"
                                        style={{ width: '120px', height: '120px' }}
                                    >
                                        <i className="fas fa-user-shield fa-3x"></i>
                                    </div>
                                    <h4 className="fw-extrabold text-gray-900 tracking-tightest mb-3">
                                        CLINICAL RECORDS RESTRICTED
                                    </h4>
                                    <p
                                        className="text-muted fw-medium mx-auto opacity-75"
                                        style={{ maxWidth: '500px' }}
                                    >
                                        Access to detailed clinical logs, examinations, and diagnostic plans is
                                        restricted to clinical personnel and authorized staff. If you require copies of
                                        your medical reports, please request them from the reception desk.
                                    </p>
                                </div>
                            </div>
                        )}
            ...
            <UnifiedToolbar
                actions={[
                    !['patient', 'receptionist', 'lab_technician'].includes(auth.user.role) && {
                        ...
                        icon: 'fa-print',
                        onClick: () =>
                            window.open(route('consultations.print', consultation.consultation_id), '_blank'),
                    },
                    ['doctor', 'admin'].includes(auth.user.role) && {
