                    ...
                    <div className="card shadow-sm border-0 rounded-xl overflow-hidden bg-white">
                        <div className="card-header bg-white border-bottom p-4 d-flex justify-content-between align-items-center">
                            ...
                            <div className="text-end">
                                ...
                                <div className="extra-small text-muted">{formatDateTime(message.created_at)}</div>
                            </div>
                        </div>
                        <div className="card-body p-4">
                            <div className="bg-light rounded-3 p-4 mb-4" style={{ minHeight: '200px' }}>
                                <div
                                    className="text-gray-700 whitespace-pre-wrap lead font-sans"
                            ...
                            {message.reply ? (
                                        ...
                                        <div className="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <span className="text-muted small">
                                                    by{' '}
                                                    {message.replier
                                                        ? `${message.replier.first_name} ${message.replier.last_name}`
                                                        : 'Administrator'}
                                                </span>
                                            </div>
                                        </div>
                                        <div className="text-muted small">{formatDateTime(message.replied_at)}</div>
                                    </div>
                                    <div
                                ...
                                <form
                                    ...
                                    className="mb-4 p-4 border border-light-subtle rounded-3 bg-light bg-opacity-25"
                                >
                            ...
                            <div className="d-flex justify-content-between align-items-center pt-2">
                                <Link href={route('admin.messages.index')} className="btn btn-light rounded-pill px-4">
