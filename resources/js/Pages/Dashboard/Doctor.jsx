    ...
    const statItems = [
        {
            ...
            value: stats.today_appointments?.length || 0,
            icon: 'fa-calendar-check',
            color: 'info',
        },
        {
            label: 'Pending Reviews',
            value: (stats.in_progress_consultations?.length || 0) + (stats.released_labs?.length || 0),
            icon: 'fa-clock',
            color: 'warning',
        },
        {
            label: 'Completed (Today)',
            value: stats.completed_today?.length || 0,
            ...
            >
                <div className="row g-4">
                    <div className="col-lg-8">
                        <DashboardPanel title="Patient schedule tracker" icon="fa-calendar-alt" className="mb-4">
                            {activeTab === 'start' && (
                                <DashboardTable
