    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                accessorKey: 'doctor',
                cell: ({ row }) => (
                    <TableCellPrimary className="text-muted">Dr. {row.original.doctor.user.last_name}</TableCellPrimary>
                ),
            },
            {
                header: 'Action',
                            ...
                            actions={
                                <span className="badge rounded-pill bg-success text-white border px-3 py-1 fw-bold extra-small d-flex align-items-center gap-1">
                                    <span
                                        ...
                                        style={{ width: 6, height: 6, animation: 'pulse 2s infinite' }}
                                    ></span>
                                    Live
                                </span>
                            }
                ...
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border-0">
                    <div className="bg-danger text-white p-4 d-flex justify-content-between align-items-center">
                        <h5 className="mb-0 fw-extrabold">
                            <i className="fas fa-exclamation-triangle me-2"></i>Emergency triage
                        </h5>
                        <button
                            type="button"
                    ...
                    <div className="p-5">
                        <p className="text-muted small fw-medium mb-4">
                            Select a patient to initiate an immediate emergency consultation. This action will bypass
                            the standard queue.
                        </p>
                        <div className="mb-4">
                            <label className="form-label extra-small fw-bold text-muted mb-2">
                        ...
                        <div className="text-end">
                            <button
                                type="button"
                                className="btn btn-light rounded-pill px-4 py-2 fw-bold border text-muted"
                                onClick={() => setIsEmergencyModalOpen(false)}
                            >
                                Cancel
                            </button>
