...
export default function Create({ patient_id, consultation_id, consultation, consultation_fee, auth }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        items: [{ description: 'Consultation Fee', quantity: 1, unit_price: consultation_fee || 0 }],
        notes: '',
    });
                        ...
                        <div className="col-lg-4">
                            ...
                            <div className="card border-0 shadow-sm rounded-4 bg-pink-500 text-white shadow-premium">
                                <div className="card-body p-5">
                                    <h6 className="text-white-50 text-uppercase extra-small fw-extrabold tracking-widest mb-1">
                                        Total Payable
                                    </h6>
