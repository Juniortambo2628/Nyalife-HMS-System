                            ...
                            <form onSubmit={submit}>
                                <div className="row g-4">
                                    ...
                                    <div className="col-md-12 mt-4">
                                        <label className="extra-small fw-extrabold text-pink-500 text-uppercase tracking-widest mb-2 d-block">
                                            Investigation Type <span className="text-danger">*</span>
                                        </label>
                                        <select
                                        ...
                                        {errors.test_type_id && (
                                            <div className="invalid-feedback">{errors.test_type_id}</div>
                                        )}
                                    </div>
                                        ...
                                        <div className="d-flex gap-3">
                                            ...
                                            <div className="form-check">
                                                <input
                                                    ...
                                                    onChange={(e) => setData('priority', e.target.value)}
                                                />
                                                <label className="form-check-label text-danger" htmlFor="urgent">
                                                    Urgent
                                                </label>
                                            </div>
                                            <div className="form-check">
                                                <input
                                                    ...
                                                    id="stat"
                                                    value="stat"
                                                    checked={data.priority === 'stat'}
                                                    onChange={(e) => setData('priority', e.target.value)}
                                                />
                                                <label className="form-check-label text-dark fw-bold" htmlFor="stat">
                                                    STAT
                                                </label>
                                            </div>
                                        </div>
