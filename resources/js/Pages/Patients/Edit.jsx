                        ...
                        <div className="card shadow-sm border-0">
                            <div className="card-body p-4 p-md-5">
                                <form onSubmit={submit}>
                                    ...
                                    <h5 className="mb-4 border-bottom pb-2 text-primary">
                                        Clinical Profile & Insurance
                                    </h5>
                                    <div className="row g-3 mb-4">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <textarea
                                                className={`form-control ${errors.chronic_diseases ? 'is-invalid' : ''}`}
                                                rows="2"
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <input
                                                type="text"
                                                className={`form-control ${errors.insurance_provider ? 'is-invalid' : ''}`}
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <input
                                                type="text"
                                                className={`form-control ${errors.insurance_id ? 'is-invalid' : ''}`}
                                    ...
                                    <div className="row g-3 mb-4">
                                        <div className="col-md-6">
                                            ...
                                            {errors.emergency_name && (
                                                <div className="invalid-feedback">{errors.emergency_name}</div>
                                            )}
                                        </div>
                                        <div className="col-md-6">
