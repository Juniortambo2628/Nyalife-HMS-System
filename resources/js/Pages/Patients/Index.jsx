...
export default function Index({ patients, filters, auth, stats }) {
    ...
    const applyFilters = (searchValue) => {
        router.get(
            ...
            { search: searchValue, status: activeFilter },
            {
                preserveState: true,
                replace: true,
            },
                ...
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="d-flex align-items-center gap-2">
                            <span
                                className={`badge rounded-pill px-3 py-1.5 fw-extrabold extra-small border ${isMale ? 'bg-blue-50 text-blue-600 border-blue-100' : isFemale ? 'bg-pink-50 text-pink-600 border-pink-100' : 'bg-gray-50 text-gray-600 border-gray-100'}`}
                            >
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="space-y-1">
                        ...
                        <div className="extra-small text-muted font-medium text-truncate" style={{ maxWidth: '150px' }}>
                    ...
                    <div className="d-flex align-items-center gap-3">
                        <div className="text-center border-end pe-3 border-gray-100">
                            <div className="fw-extrabold text-gray-900 small">
                                {row.original.consultations_count || 0}
                            </div>
                            <div className="extra-small text-muted font-bold uppercase opacity-50 tracking-tighter">
                                Visits
                            </div>
                        </div>
                        <div className="text-center">
                            <div className="fw-extrabold text-gray-900 small">
                                {row.original.appointments_count || 0}
                            </div>
                            <div className="extra-small text-muted font-bold uppercase opacity-50 tracking-tighter">
                                Slots
                            </div>
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="row g-5">
                            <div className="col-md-6 border-end border-gray-100">
                                <h6 className="extra-small fw-extrabold text-primary text-uppercase tracking-widest mb-4 opacity-50">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                        ...
                                        <span className="fw-extrabold text-gray-900 small text-uppercase">
                                            {patient.gender}
                                        </span>
                                    </div>
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                        ...
                                        <span className="badge bg-danger rounded-pill px-3 py-1 fw-extrabold extra-small">
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="space-y-4">
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                        ...
                                        <span className="fw-extrabold text-gray-900 small font-mono">
                                            {patient.user.phone}
                                        </span>
                                    </div>
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                        ...
                                        <span
                                            className="fw-extrabold text-gray-900 small text-truncate"
                                    ...
                                    <div className="pt-2">
                                        <span className="extra-small fw-bold text-muted text-uppercase d-block mb-1">
                                            Residential Address
                                        </span>
                                        <span className="small fw-bold text-gray-700 leading-relaxed">
                                            {patient.address || 'Address not recorded in system'}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-4 bg-pink-50 rounded-2xl border border-pink-100 shadow-inner nyl-content-box nyl-content-box--highlight">
                            <h6 className="nyl-content-box__title nyl-content-box__title--pink mb-3">
                            ...
                            <div className="fw-extrabold text-gray-800 d-flex align-items-center gap-3">
                                ...
                                {patient.emergency_contact && (
                                    <span className="opacity-50 font-mono small">— {patient.emergency_contact}</span>
                                )}
                            </div>
                        </div>
                    </div>
            ...
            },
            {
                ...
                content: (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <h6 className="extra-small fw-extrabold text-primary text-uppercase tracking-widest opacity-50 mb-4">
                        ...
                        {patient.consultations?.length > 0 ? (
                            <div className="space-y-3">
                                {patient.consultations.map((c, i) => (
                                    <div
                                        key={i}
                                        className="p-4 rounded-2xl border border-gray-100 hover-lift transition-all bg-white shadow-sm d-flex gap-4 align-items-center"
                                    >
                                        ...
                                        <div className="flex-1 overflow-hidden">
                                            <div className="d-flex justify-content-between align-items-center mb-1">
                                                <div className="fw-extrabold text-gray-900 text-truncate">
                                            ...
                                            <p className="extra-small text-muted font-medium mb-0 text-truncate opacity-75">
                                                {c.chief_complaint}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="text-center py-16 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
                                ...
                                <p className="extra-small fw-extrabold text-muted text-uppercase tracking-widest mb-0 opacity-50">
    ...
    return (
        <AuthenticatedLayout headerTitle="Patients Registry" breadcrumbs={[{ label: 'Patients', active: true }]}>
            <Head title="Patients" />
                ...
                bulkActions={[
                    {
                        ...
                        icon: 'fa-file-export',
                        onClick: () =>
                            handleBulkAction('export', (action, ids) => {
                    ...
                    },
                    {
                        ...
                        icon: 'fa-id-card',
                        onClick: () =>
                            handleBulkAction('print_cards', (action, ids) => {
                    ...
                    <div className="row g-4">
                        {patients.data.length > 0 ? (
                                            ...
                                            <div className="card-body p-4">
                                                <div className="d-flex justify-content-between align-items-start mb-5">
                                                    <div className="d-flex gap-3">
                                                        ...
                                                        />
                                                        <div>
                                                            <h5 className="fw-extrabold text-gray-900 mb-0 tracking-tightest">
                                                    ...
                                                    <span className="badge bg-primary-subtle text-primary rounded-pill px-3 py-1.5 fw-extrabold extra-small border border-primary-subtle">
                                                        {calculateAge(p.date_of_birth)}Y /{' '}
                                                ...
                                                <div className="space-y-4 mb-5 px-1">
                                                    <div className="d-flex align-items-center gap-3">
                                                        <div className="avatar-xs bg-gray-50 text-gray-400 rounded-lg d-flex align-items-center justify-content-center border">
                                                            <i className="fas fa-phone-alt extra-small"></i>
                                                        </div>
                                                        <span className="fw-bold text-gray-700 small font-mono">
                                                            {p.user.phone || 'N/A'}
                                                        </span>
                                                    </div>
                                                    <div className="d-flex align-items-center gap-3">
                                                        <div className="avatar-xs bg-gray-50 text-gray-400 rounded-lg d-flex align-items-center justify-content-center border">
                                                            <i className="fas fa-history extra-small"></i>
                                                        </div>
                                                        <span className="fw-extrabold text-gray-900 small">
                                                            {p.consultations_count || 0} Clinical Encounters
                                                        </span>
                                                    </div>
                                                </div>
                            ...
                            <div className="col-12 py-24 text-center bg-white rounded-4 shadow-sm border border-gray-100">
                                ...
                                <p className="text-muted extra-small fw-bold text-uppercase tracking-widest opacity-50">
                                    Adjust your search parameters or initiate a new registration.
                                </p>
                            </div>
                        )}
                    </div>
            ...
            {/* Hidden CSV Input */}
            <input type="file" id="csvFileInput" accept=".csv" className="d-none" onChange={handleFileChange} />
            ...
            <InfoModal
                ...
                title={
                    modalConfig.patient
                        ? `${modalConfig.patient.user.first_name} ${modalConfig.patient.user.last_name}`
                        : ''
                }
