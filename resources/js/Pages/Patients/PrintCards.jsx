                ...
                <div className="d-flex flex-wrap gap-5 justify-content-center align-items-start pb-5">
                    {patients.map((patient) => (
                        <div
                            ...
                            className="d-flex flex-row gap-4 align-items-center print-card-wrapper"
                            style={{ pageBreakInside: 'avoid' }}
                        >
                            {/* FRONT OF CARD */}
                            <div
                                className="print-card rounded-4 overflow-hidden d-flex flex-column shadow-sm"
                                style={{
                                    width: '3.75in',
                                    height: '2.25in',
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <h6
                                            className="mb-0 fw-extrabold tracking-tight text-white"
                                            style={{ fontSize: '14px', margin: 0 }}
                                        >
                                            Nyalife HMS
                                        </h6>
                                        <div
                                            className="opacity-75 font-mono fw-bold text-white"
                                            style={{ fontSize: '10px' }}
                                        >
                                    ...
                                    <i
                                        className="fas fa-hospital-symbol text-white opacity-50"
                                        style={{ fontSize: '24px' }}
                                    ></i>
                                </div>
                                ...
                                <div className="px-3 py-2 text-start flex-grow-1 bg-white d-flex flex-column justify-content-center">
                                    <h6
                                        className="fw-extrabold text-gray-900 mb-1 text-truncate"
                                        style={{ fontSize: '16px' }}
                                    >
                                        {patient.user?.first_name} {patient.user?.last_name}
                                    </h6>
                                    <div
                                        className="text-muted fw-bold mb-2 text-uppercase tracking-widest"
                                        style={{ fontSize: '10px' }}
                                    >
                                        {(patient.gender || 'U').charAt(0)} / {patient.blood_group || 'N/A'}
                                    </div>
                                    <div
                                        className="d-flex flex-column gap-1 font-mono text-gray-700 fw-bold"
                                        style={{ fontSize: '11px' }}
                                    >
                                        <div>
                                            <i
                                                className="fas fa-phone-alt me-2"
                                                style={{ color: '#ec4899', width: '12px' }}
                                            ></i>
                                        ...
                                        <div>
                                            <i
                                                ...
                                                style={{ color: '#ec4899', width: '12px' }}
                                            ></i>
                                            DOB: {patient.date_of_birth ? patient.date_of_birth.split('T')[0] : 'N/A'}
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Card Footer */}
                                <div
                                    className="w-100 border-top text-center py-1 text-muted fw-bold tracking-widest text-uppercase"
                                    style={{ backgroundColor: '#f9fafb', fontSize: '9px' }}
                                >
                            ...
                            >
                                ...
                                <div className="px-3 py-2 text-start flex-grow-1 bg-white d-flex flex-column">
                                    <div className="mb-2">
                                        ...
                                        <div
                                            className="fw-extrabold text-gray-800 text-truncate"
                                            style={{ fontSize: '11px' }}
                                        >
                                            {patient.emergency_name || 'Not Provided'}
                                        </div>
                                        <div className="font-mono text-gray-600 fw-bold" style={{ fontSize: '10px' }}>
                                    ...
                                    <div className="mb-2">
                                        ...
                                        <div
                                            className="font-mono text-gray-800 fw-bold text-truncate"
                                            style={{ fontSize: '10px' }}
                                        >
                                            {patient.user?.email || 'No email on file'}
                                        </div>
                                        <div className="text-gray-600 text-truncate" style={{ fontSize: '9px' }}>
                                    ...
                                    <div className="mt-auto border-top pt-1 text-center">
                                        <div
                                            className="text-uppercase tracking-widest fw-bold"
                                            style={{ fontSize: '7px', color: '#ec4899' }}
                                        >
                                            If found, please return to:
                                        </div>
                                        <div className="fw-bold text-gray-800" style={{ fontSize: '8px' }}>
                                            Nyalife Hospital & Medical Center
                                        </div>
                                    </div>
                                </div>
                            </div>
