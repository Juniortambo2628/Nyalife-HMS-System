    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                header: 'Amount',
                accessorKey: 'amount',
                cell: (info) => <TableCellPrimary>{formatCurrency(info.getValue())}</TableCellPrimary>,
            },
            {
                header: 'Method',
                accessorKey: 'payment_method_label',
                cell: (info) => (
                    <TableCellPrimary className="text-uppercase text-muted">{info.getValue()}</TableCellPrimary>
                ),
            },
            {
                header: 'Status',
                ...
                filterGroups={[
                    {
                        ...
                        onChange: (val) => {
                            setStatus(val || '');
                            applyFilters(search, val || '', method);
                        },
                        options: [
