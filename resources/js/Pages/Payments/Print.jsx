    ...
    return (
        <div className="print-container p-5 bg-white">
            ...
            <div className="d-flex justify-content-between align-items-center mb-5 border-bottom pb-4">
                <div>
                    <img src="/assets/img/logo/Logo2-transparent.png" alt="Nyalife" style={{ height: '70px' }} className="mb-2" />
            ...
            <div className="row mb-4">
                <div className="col-6">
                    ...
                    <p className="fw-bold mb-0">{inv?.patient?.user?.first_name} {inv?.patient?.user?.last_name}</p>
                ...
                <div className="col-6 text-end">
                    ...
                    <p className="mb-0"><strong>Method:</strong> {payment.payment_method_label}</p>
                    {payment.transaction_reference && (
                        <p className="mb-0"><strong>Ref:</strong> {payment.transaction_reference}</p>
                    )}
                </div>
            </div>
            ...
            {payment.notes && <p className="text-muted small"><em>{payment.notes}</em></p>}

            <div className="mt-5 pt-4 text-center text-muted small">
                <p>Received by: {payment.received_by_user?.first_name} {payment.received_by_user?.last_name}</p>
