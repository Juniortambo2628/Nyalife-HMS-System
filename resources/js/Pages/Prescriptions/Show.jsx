            ...
            cell: ({ row }) => {
                ...
                return (
                    <span className="fw-extrabold text-gray-900">
                        {item.medication?.medication_name || item.medicine_name || 'N/A'}
                    </span>
                );
            },
        },
                ...
                <div className="row">
                    <div className="col-lg-4">
                        <div className="card shadow-sm border-0 mb-4 text-center p-5 rounded-4 bg-white shadow-hover">
                            <div className="mb-4">
                                <span
                                    className={`badge rounded-pill px-3 py-2 fw-extrabold extra-small tracking-widest ${prescription.status === 'dispensed' ? 'bg-success text-white' : 'bg-warning text-dark'}`}
                                >
                            ...
                            <h5 className="mb-1 fw-extrabold text-gray-900 tracking-tighter">
                                {prescription.patient?.user?.first_name || 'Unknown'}{' '}
                                {prescription.patient?.user?.last_name || 'Patient'}
                            </h5>
                            <PatientIdLabel
                            ...
                            <div className="space-y-3 pt-4 border-top border-gray-50 text-start">
                                <div className="d-flex justify-content-between align-items-center">
                                    <span className="extra-small fw-bold text-muted text-uppercase tracking-widest">
                                        Prescribed
                                    </span>
                                    <span className="fw-extrabold text-gray-800 small">
                            ...
                            {prescription.consultation_id && (
                                <div className="text-start p-3 bg-light rounded my-4">
                                    ...
                                    <div
                                        className="mb-3 small text-truncate"
                                        title={
                                    ...
                                    <Link
                                        href={route('consultations.show', prescription.consultation_id)}
                            ...
                            {auth.user.role === 'pharmacist' && prescription.status === 'pending' && (
                                <button
                                    onClick={() =>
                                        router.post(route('prescriptions.dispense', prescription.prescription_id))
                                    }
                                    className="btn btn-success w-100 shadow-sm mt-4"
                                >
                        ...
                        <div className="card shadow-sm border-0 rounded-4 overflow-hidden bg-white shadow-hover">
                            ...
                            {prescription.notes && (
                                <div className="p-4 bg-gray-50 rounded-xl m-4 mt-0 border border-gray-100 shadow-inner">
                                    <h6 className="extra-small fw-extrabold text-muted text-uppercase tracking-widest mb-2 opacity-50">
                                        Clinical Notes / Instructions
                                    </h6>
                                    <p className="mb-0 text-gray-700 font-medium small italic">
                                        "{prescription.notes}"
                                    </p>
                                </div>
                            )}
            ...
            <UnifiedToolbar
                actions={[
                        ...
                        },
                    {
                        ...
                        icon: 'fa-print',
                        onClick: () =>
                            window.open(route('prescriptions.print', prescription.prescription_id), '_blank'),
                    },
                    {
                        ...
                        <div className="modal-content border-0 shadow-lg rounded-4">
                            ...
                            <div className="modal-body p-4 pt-0">
                                <p className="text-muted mb-4">
                                    ...
                                    <strong>RX-{String(prescription.prescription_id).padStart(5, '0')}</strong>? This
                                    action will mark it as voided but keep it in the system for auditing purposes.
                                </p>
