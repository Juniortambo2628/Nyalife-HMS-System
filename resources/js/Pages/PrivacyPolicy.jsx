                ...
                <div className="card shadow-sm border-0 rounded-4 overflow-hidden">
                    ...
                    <div className="card-body p-4 p-md-5">
                        <section className="mb-5">
                            ...
                            <p>
                                Welcome to Nyalife HMS. We respect your privacy and are committed to protecting your
                        ...
                        <section className="mb-5">
                            ...
                            <ul>
                                <li>
                                    <strong>Identity Data:</strong> includes first name, last name, username, and title.
                                </li>
                                <li>
                                ...
                                <li>
                                    <strong>Medical Data:</strong> includes consultations, prescriptions, and lab
                                    reports.
                                </li>
                                <li>
