...
export default function Show({ request, auth }) {
    ...
    const submit = (statusOverride) => {
        ...
        post(route('radiology.update-status', request.request_id), {
            ...data,
            status: targetStatus,
        ...
        >
            ...
            {isPrinting && (
                <div className="d-none d-print-block mb-5 text-center">
                    ...
                    <p className="extra-small fw-bold text-muted text-uppercase tracking-widest">Diagnostic Imaging & Radiology Report</p>
                    <hr className="my-4" />
                </div>
            )}
                    ...
                    <div className="col-lg-4 d-print-block col-print-4">
                        <div className="card shadow-sm border-0 rounded-2xl overflow-hidden mb-4 bg-white shadow-hover">
                            <div className="card-header bg-white py-4 border-bottom-0 d-print-none">
                                <h6 className="mb-0 fw-extrabold text-uppercase tracking-widest extra-small text-pink-500">Patient Registry</h6>
                            </div>
                            <div className="card-body p-4 pt-0 pt-print-4">
                                <div className="d-flex align-items-center mb-4 p-3 bg-light rounded-2xl border border-light shadow-inner">
                                    <div className="avatar-md me-3 flex-shrink-0 rounded-lg d-flex align-items-center justify-content-center fw-extrabold text-white" 
                                         style={{ background: 'linear-gradient(135deg, #e91e63, #c2185b)', fontSize: '1.25rem', width: '50px', height: '50px' }}>
                        ...
                        <div className="card shadow-sm border-0 rounded-2xl overflow-hidden bg-white mb-4 shadow-hover">
                            <div className="card-header bg-white py-4 border-bottom-0 d-print-none">
                                <h6 className="mb-0 fw-extrabold text-uppercase tracking-widest extra-small text-pink-500">Order Information</h6>
                            </div>
                            <div className="card-body p-4 pt-0 pt-print-4">
                                <div className="space-y-4">
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                        <span className="text-muted extra-small fw-bold text-uppercase">Ref Number</span>
                                        <span className="small fw-extrabold text-gray-900">{request.request_number}</span>
                                    </div>
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                        <span className="text-muted extra-small fw-bold text-uppercase">Attending Physician</span>
                                        <span className="small fw-extrabold text-gray-900">Dr. {request.requestedBy?.last_name || 'Staff'}</span>
                                    </div>
                                    <div className="d-flex justify-content-between align-items-center border-bottom border-gray-50 pb-2">
                                        ...
                                        <span className={`badge rounded-pill px-3 py-1 fw-extrabold extra-small text-uppercase ${
                                            request.priority === 'emergency' ? 'bg-danger text-white' : 
                                            request.priority === 'urgent' ? 'bg-warning text-dark' : 'bg-info text-white'
                                        }`}>
                                            {request.priority}
                                        </span>
                                    </div>
                                    <div className="d-flex justify-content-between align-items-center">
                                        <span className="text-muted extra-small fw-bold text-uppercase">Current Status</span>
                        ...
                        {request.consultation_id && (
                            <Link href={route('consultations.show', request.consultation_id)} className="btn btn-outline-primary w-100 rounded-pill py-3 fw-extrabold extra-small tracking-widest shadow-sm shadow-hover d-print-none">
                    ...
                    <div className="col-lg-8 d-print-block col-print-8">
                        ...
                        <div className="card shadow-sm border-0 rounded-2xl overflow-hidden mb-4 bg-white shadow-hover">
                            <div className="card-header bg-white py-4 border-bottom-0 d-flex justify-content-between align-items-center">
                                <h6 className="mb-0 fw-extrabold text-uppercase tracking-widest extra-small text-pink-500">Order Clinical Indication</h6>
                            </div>
                            <div className="card-body p-4 pt-0">
                                {isReceptionist ? (
                                    <div className="p-4 rounded-2xl bg-light-warning border border-warning-subtle text-muted text-center shadow-inner d-print-none">
                                        ...
                                        <span className="fw-semibold small">Clinical indications and details are restricted from administrative roles under strict HIPAA compliance rules.</span>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-2xl bg-light-info border border-info-subtle text-muted text-center shadow-inner">
                                        ...
                                        <span className="fw-semibold small">Your clinical request details are under secure review and will be visible once certified by the doctor.</span>
                                    </div>
                                ) : (
                                    <div className="row g-3">
                                        <div className="col-md-6">
                                            <div className="p-4 rounded-2xl bg-gray-50 border border-gray-100 shadow-inner h-100">
                                                <div className="text-muted extra-small fw-extrabold text-uppercase tracking-widest mb-2">Clinical Indication</div>
                                                <div className="fw-bold text-gray-800" style={{ whiteSpace: 'pre-line' }}>{request.clinical_indication || 'No indications specified.'}</div>
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div className="p-4 rounded-2xl bg-gray-50 border border-gray-100 shadow-inner h-100">
                                                <div className="text-muted extra-small fw-extrabold text-uppercase tracking-widest mb-2">Instructions / Details</div>
                                                <div className="fw-medium text-gray-700" style={{ whiteSpace: 'pre-line' }}>{request.scan_details || 'No instructions provided.'}</div>
                                            </div>
                                        </div>
                                    </div>
                                )}
                        ...
                        <div className="card shadow-sm border-0 rounded-2xl overflow-hidden bg-white shadow-hover">
                            <div className="card-header bg-gradient-primary-to-secondary text-white py-4 border-0 d-print-none">
                                <h6 className="mb-0 fw-extrabold text-uppercase tracking-widest extra-small">Diagnostic Findings & Reporting</h6>
                            </div>
                            <div className="card-body p-4 p-md-5">
                                {isReceptionist ? (
                                    <div className="text-center py-5 d-print-none">
                                        <i className="fas fa-user-shield text-pink-500 fa-3x mb-3 opacity-30"></i>
                                        <h5 className="fw-extrabold text-gray-900 tracking-tighter">Administrative Privacy Restricted</h5>
                                        <p className="text-muted small max-w-md mx-auto">This report contains HIPAA-protected clinical information, including findings and diagnostic impressions. Access is limited to authorized clinical practitioners only.</p>
                                    </div>
                                ) : isPatient && !['verified', 'completed'].includes(request.status) ? (
                                    <div className="text-center py-5">
                                        <i className="fas fa-spinner fa-spin text-pink-500 fa-3x mb-3"></i>
                                        <h5 className="fw-extrabold text-gray-900 tracking-tighter">Scan Awaiting Verification</h5>
                                        <p className="text-muted small max-w-md mx-auto">Your scan report has been sent to our chief medical practitioner for verification. We will notify you immediately once results are ready and signed off.</p>
                                    </div>
                                ) : (
                                    <div>
                                        {/* Status & Stamps */}
                                        <div className="text-center mb-5 d-print-none">
                                            {request.status === 'pending' && (
                                                <>
                                                    <div className="bg-warning-subtle text-warning p-4 rounded-circle d-inline-flex align-items-center justify-content-center mb-3 border border-warning-subtle" style={{ width: '80px', height: '80px' }}>
                                                        <i className="fas fa-clock fa-2x"></i>
                                                    </div>
                                                    <h4 className="fw-extrabold text-warning tracking-tighter">ORDER IS PENDING</h4>
                                                    <p className="extra-small fw-bold text-muted text-uppercase tracking-widest opacity-75">Click 'Start Scanning' below to process this patient scan</p>
                                                </>
                                            )}
                                            {request.status === 'processing' && (
                                                <>
                                                    <div className="bg-info-subtle text-info p-4 rounded-circle d-inline-flex align-items-center justify-content-center mb-3 border border-info-subtle" style={{ width: '80px', height: '80px' }}>
                                                        <i className="fas fa-spinner fa-spin fa-2x"></i>
                                                    </div>
                                                    <h4 className="fw-extrabold text-info tracking-tighter">SCAN IN PROGRESS</h4>
                                                    <p className="extra-small fw-bold text-muted text-uppercase tracking-widest opacity-75">Technician is currently compiling clinical scan findings</p>
                                                </>
                                            )}
                                            {request.status === 'pending_verification' && (
                                                <>
                                                    <div className="bg-warning-subtle text-warning p-4 rounded-circle d-inline-flex align-items-center justify-content-center mb-3 border border-warning-subtle animate-pulse-custom" style={{ width: '80px', height: '80px' }}>
                                                        <i className="fas fa-history fa-2x"></i>
                                                    </div>
                                                    <h4 className="fw-extrabold text-warning-emphasis tracking-tighter">AWAITING CLINICAL SIGN-OFF</h4>
                                                    <p className="extra-small fw-bold text-muted text-uppercase tracking-widest opacity-75">Results compiled, awaiting attending physician verification</p>
                                                </>
                                            )}
                                            {['verified', 'completed'].includes(request.status) && (
                                                <>
                                                    <div className="bg-success-subtle text-success p-4 rounded-circle d-inline-flex align-items-center justify-content-center mb-3 border border-success-subtle" style={{ width: '80px', height: '80px' }}>
                                                        <i className="fas fa-check-double fa-2x"></i>
                                                    </div>
                                                    <h4 className="fw-extrabold text-success tracking-tighter">REPORT VERIFIED & SIGNED OFF</h4>
                                                    <p className="extra-small fw-bold text-muted text-uppercase tracking-widest opacity-75">
                                                        Clinical record verified by {request.verifiedByUser ? `Dr. ${request.verifiedByUser.first_name} ${request.verifiedByUser.last_name}` : 'Attending Physician'}
                                                    </p>
                                                </>
                                            )}
                                        </div>
                                            ...
                                            <div className="d-flex align-items-center justify-content-between p-4 rounded-2xl mb-4 bg-success-subtle border border-success text-success shadow-sm">
                                                <div>
                                                    <div className="fw-extrabold tracking-tighter uppercase d-flex align-items-center gap-2">
                                                        <i className="fas fa-shield-check"></i> Verified Digital Clinical Record
                                                    </div>
                                        ...
                                        {['verified', 'completed'].includes(request.status) ? (
                                            <div className="space-y-4 animate-in fade-in duration-300">
                                                <div className="p-4 rounded-2xl bg-gray-50 border border-gray-100 shadow-inner">
                                                    <h6 className="extra-small fw-extrabold text-uppercase text-pink-500 tracking-widest mb-3">Diagnostic Findings</h6>
                                                    <div className="fw-bold text-gray-800" style={{ whiteSpace: 'pre-line', fontSize: '1rem', lineHeight: '1.6' }}>
                                                        {request.findings}
                                                    </div>
                                                </div>

                                                <div className="p-4 rounded-2xl bg-gray-100 border border-gray-200 shadow-inner">
                                                    <h6 className="extra-small fw-extrabold text-uppercase text-pink-500 tracking-widest mb-3">Diagnostic Impression</h6>
                                                    <div className="fw-extrabold text-pink-600" style={{ whiteSpace: 'pre-line', fontSize: '1.05rem', lineHeight: '1.5' }}>
                                                        {request.impression}
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="row g-4">
                                                    ...
                                                    {request.status === 'pending' && (
                                                        <div className="col-md-12 text-center py-4 bg-light rounded-3xl border border-dashed">
                                                            <p className="fw-bold text-muted mb-3">This radiology scan has not been started yet.</p>
                                                            <button 
                                                                type="button" 
                                                    ...
                                                    {['processing', 'pending_verification'].includes(request.status) && (
                                                        <>
                                                            ...
                                                            <div className="col-md-12">
                                                                <label className="extra-small fw-extrabold text-pink-500 text-uppercase tracking-widest mb-2 d-block">
                                                                    Diagnostic Impression <span className="text-danger">*</span>
                                                                </label>
                                                                <textarea 
                                                                    ...
                                                                    required
                                                                />
                                                                {errors.impression && <div className="text-danger small mt-1">{errors.impression}</div>}
                                                            </div>
                                                            ...
                                                            <div className="col-md-12 mt-4 d-flex flex-wrap gap-3">
                                                                ...
                                                                {request.status === 'processing' && (
                                                                    <button 
                                                                        ...
                                                                        disabled={processing || !data.findings || !data.impression}
                                                                    >
                                                                        <i className="fas fa-check-circle me-1"></i> Submit for Verification
                                                                    </button>
                                                                )}

                                                                {/* Doctor / Admin Verification */}
                                                                {request.status === 'pending_verification' && isAttendingOrAdmin && (
                                                                    <button 
                                                                        type="button" 
                                                                        ...
                                                                        disabled={processing || !data.findings || !data.impression}
                                                                    >
                                                                        <i className="fas fa-check-double me-2"></i> Verify & Sign Off Report
                                                                    </button>
                                                                )}
