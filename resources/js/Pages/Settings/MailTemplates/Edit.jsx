                                ...
                                <form onSubmit={submit}>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        {errors.html_template && (
                                            <div className="invalid-feedback">{errors.html_template}</div>
                                        )}
                        ...
                        <div className="card border-0 shadow-sm rounded-4 bg-light">
                            <div className="card-body p-4">
                                <h6 className="fw-bold mb-3">
                                    <i className="fas fa-magic me-2 text-primary"></i> Template Tips
                                </h6>
                                <ul className="list-unstyled mb-0 small text-muted">
                                    <li className="mb-3">
                                        <strong>Placeholders:</strong> You can use placeholders like{' '}
                                        <code>{`{{ first_name }}`}</code>, <code>{`{{ last_name }}`}</code>, etc.,
                                        depending on the data sent to the notification.
                                    </li>
                                    <li className="mb-3">
                                        <strong>Styling:</strong> Use inline CSS for maximum compatibility across email
                                        clients.
                                    </li>
                                    <li>
                                        <strong>Fallback:</strong> If no template is found, the system uses the default
                                        Laravel notification layout.
                                    </li>
                                </ul>
                            </div>
                        </div>
