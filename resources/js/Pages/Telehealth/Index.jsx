    ...
    return (
        <div className="bg-light min-vh-100 pb-5">
            ...
            <div
                ...
                style={{ background: 'linear-gradient(135deg, #1e293b 0%, #831843 100%)' }}
            >
                <div className="container">
                    <div className="d-flex align-items-center justify-content-between mb-4">
                        <Link href="/" className="d-flex align-items-center text-white text-decoration-none">
                            ...
                            <span className="fw-extrabold fs-3 tracking-tightest">
                                NYALIFE <span className="fw-light opacity-75">HMS</span>
                            </span>
                        </Link>
                        {isLoggedIn ? (
                            <Link href={route('dashboard')} className="btn btn-outline-light rounded-pill px-4">
                                Dashboard
                            </Link>
                        ) : (
                            <Link href={route('login.patient')} className="btn btn-outline-light rounded-pill px-4">
                                Patient Login
                            </Link>
                        )}
                    </div>
                    ...
                    <div className="row align-items-center mt-5">
                        <div className="col-lg-8">
                            ...
                            <p className="lead opacity-75 mb-0">
                                Convenient Care, Wherever You Are! Connect with our clinical specialists online with
                    ...
                    {[
                        {
                            ...
                            desc: 'Call or text us to request a telehealth appointment.',
                            icon: 'fa-phone',
                            color: 'bg-primary-subtle text-primary',
                        },
                        {
                            title: '2. Preferred Slot',
                            desc: 'Share your preferred Day & Time - we will match your schedule.',
                            icon: 'fa-calendar-alt',
                            color: 'bg-info-subtle text-info',
                        },
                        {
                            title: '3. Pay via Till',
                            desc: 'Pay via our clinic Till Number (details will be texted to you).',
                            icon: 'fa-credit-card',
                            color: 'bg-warning-subtle text-warning',
                        },
                        {
                            title: '4. Sign Consent',
                            desc: 'Read and sign the digital Consent Form below.',
                            icon: 'fa-file-signature',
                            color: 'bg-danger-subtle text-danger',
                        },
                        {
                            title: '5. Join Meeting',
                            desc: 'Receive your booking confirmation & meeting link via email/text.',
                            icon: 'fa-video',
                        ...
                        <div key={idx} className="col-lg-2-4 col-md-4 col-sm-6">
                            <div className="card border-0 shadow-sm rounded-4 p-4 h-100 text-center">
                                <div
                                    className={`rounded-circle d-inline-flex align-items-center justify-content-center mx-auto mb-3 ${step.color}`}
                    ...
                    <div className="col-lg-12">
                        <div className="card border-0 shadow-sm rounded-4 p-4 p-lg-5 bg-white">
                            ...
                            <p className="text-muted text-center mb-5">
                                Please read the terms below carefully and sign using the digital pad before submitting.
                            </p>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div
                                    className="card bg-light border-0 rounded-4 p-4 mb-4"
                                ...
                                >
                                    <div className="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2">
                                        ...
                                        <div className="form-check">
                                            ...
                                            />
                                            <label
                                                className="form-check-label small fw-bold text-slate-700"
                                                htmlFor="checkAll"
                                            >
                                                Select All
                                            </label>
                                    ...
                                    <div className="d-grid gap-3">
                                        {consentClauses.map((clause, idx) => (
                                            <div key={idx} className="form-check d-flex align-items-start gap-2">
                                                ...
                                                />
                                                <label
                                                    className="form-check-label small text-slate-700 leading-normal"
                                                    htmlFor={`clause-${idx}`}
                                                >
                                ...
                                <div className="row g-4 align-items-end">
                                    <div className="col-md-6">
                                        ...
                                        <div
                                            className="border rounded-4 bg-light p-2 position-relative"
