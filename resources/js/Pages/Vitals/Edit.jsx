                        ...
                        >
                            <div className="row g-3">
                                <div className="col-12">
                                    <h5 className="fw-bold mb-0">{vital.patient?.user?.first_name} {vital.patient?.user?.last_name}</h5>
                                    <PatientIdLabel id={vital.patient_id} variant="pat-id" className="text-muted small mb-0" />
                                </div>
                            </div>
                        </FormSection>
