                ...
                <div className="row g-5 align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div className="about-content">
                            ...
                            <h2 className="display-5 fw-bold text-gray-900 mb-6 section-title-main">
                                {cms.about_title || "About Nyalife Women's Clinic"}
                            </h2>
                            <p className="lead text-gray-700 mb-6 font-semibold">
                                {cms.about_description ||
                                    'Dedicated to providing high-quality, compassionate obstetrics and gynecology services.'}
                            </p>
                            <p className="text-gray-600 mb-8 leading-relaxed">
                                Our facility is designed to provide a comfortable and welcoming environment for women at
                                every stage of their lives. We combine medical expertise with a personal touch to ensure
