            ...
            <div className="container">
                <div className="text-center mb-16">
                    ...
                    <p className="lead text-gray-600 max-w-2xl mx-auto">
                        Staying informed is the first step towards a healthier life.
                    </p>
                </div>
                                    ...
                                    <div className="position-relative bg-light h-[220px]">
                                        <img
                                            src={resolvePublicImageUrl(
                                                blog.image_path,
                                                '/assets/img/logo/Logo2-transparent.png',
                                            )}
                                            ...
                                            onError={(e) => {
                                                ...
                                                e.target.className = 'w-100 h-100 object-fit-contain p-5 opacity-50';
                                            }}
                                        />
                ...
                <div className="text-center">
                    <Link
                        ...
                        className="btn btn-primary rounded-pill px-10 py-3.5 font-bold shadow-lg mt-10"
                    >
