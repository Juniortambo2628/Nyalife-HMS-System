                    ...
                    <div className="col-lg-10 text-start text-white">
                        <div className="hero-content animate-in fade-in slide-in-from-left-8 duration-700">
                            ...
                            <p className="text-white opacity-75 mb-4 max-w-2xl fw-normal fs-5">
                                Providing exceptional, compassionate care for every stage of your life. Experience
                                medical excellence with a heart.
                            </p>
                            ...
                            <div className="d-flex flex-wrap gap-3">
                                {!isLoggedIn ? (
                                    <>
                                        <a
                                            href="#appointment"
                                            className="btn btn-primary px-4 py-2.5 fw-medium rounded-pill shadow-sm hover-lift"
                                        >
                                            <i className="fas fa-calendar-check me-2"></i> Book Appointment
                                        </a>
                                        <Link
                                            href={route('login.patient')}
                                            className="btn btn-white bg-white text-gray-900 border-0 px-4 py-2.5 fw-medium rounded-pill shadow-sm hover-lift"
                                        >
